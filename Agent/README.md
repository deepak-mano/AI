Calc.py         ==> Langchain Agent used for Calculator function using tools for individual operation. Agent make use of llm for making decisions

dataframe.py    ==> Perform regression and classifcation operation for different data on websire source.It uses langchain agent along with llm

manual_tool.py  ==> Peform calculator operation using manual tool calling 
