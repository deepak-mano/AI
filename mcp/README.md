...
mcp_http_test.py  -> performs operations on context7 based on user queries. The connection is an http connection to context7 mcp server
...
mcp_calc   -> include the components for the calculator function using mcp http server, mcp stdio server, client, react agent and llm