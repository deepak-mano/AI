...
class MCPHTTPClientApp(MCPHTTPClient):
    ...
    """
    Validates input - Checks if tool was selected
    Parses JSON - Converts arguments string to Python dict
    Handles empty args - Allows empty string to become {}
    Calls inherited method - Uses await self.call_tool() from base
    Extracts text content - Loops through result.content array
    Error handling - Catches JSON and general errors
    Returns string - Gradio Textbox needs string output
    """
